...
Data file:
    inventory_cmdline.json (created automatically in the same folder)
"""
...
DATA_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "inventory_cmdline.json")
...
def add_item(inventory, name, quantity, category="general", location="", unit="", threshold=0):
